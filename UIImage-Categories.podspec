...
Pod::Spec.new do |s|
  ...
  s.version      = "1.0.0"
  s.summary      = "An fork of Trevor Harmon's UIImage category methods, updated for the latest versions of iOS."
  ...
  # Or just: s.author    = "Bupterambition"
  # s.authors            = { "Bupterambition" => "bupterambition@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Bupterambition"
